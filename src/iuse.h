...
std::optional<int> laudanum( Character *, item *, bool, const tripoint & );
...
std::optional<int> cooler( Character *, item *, bool, const tripoint & );
...
std::optional<int> mangle( Character *, item *, bool, const tripoint & );
...
std::optional<int> suture( Character *, item *, bool, const tripoint & );
